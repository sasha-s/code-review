#!/usr/bin/env python3
"""v2.4 ledger pipeline: v2.2 shape plus generic resource/locale rules."""
...
runner.PIPELINE_VERSION = "pipeline-v2.4"
runner.PROMPT_DIR = runner.SCRIPT_DIR / "prompts" / "pipeline-v2.4"
runner.STAGES = (
