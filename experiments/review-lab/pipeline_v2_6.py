#!/usr/bin/env python3
"""v2.6 ledger pipeline: verifier calibration on top of v2.4 shape."""
...
runner.PIPELINE_VERSION = "pipeline-v2.6"
runner.PROMPT_DIR = runner.SCRIPT_DIR / "prompts" / "pipeline-v2.6"
runner.STAGES = (
