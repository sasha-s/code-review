#!/usr/bin/env python3
"""v2.7 ledger pipeline: consequence decomposition on top of v2.6."""
...
runner.PIPELINE_VERSION = "pipeline-v2.7"
runner.PROMPT_DIR = runner.SCRIPT_DIR / "prompts" / "pipeline-v2.7"
runner.STAGES = (
