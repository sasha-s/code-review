#!/usr/bin/env python3
"""v2.8 ledger pipeline: sentinel/time/matcher consequence checks on v2.7."""
...
runner.PIPELINE_VERSION = "pipeline-v2.8"
runner.PROMPT_DIR = runner.SCRIPT_DIR / "prompts" / "pipeline-v2.8"
runner.STAGES = (
