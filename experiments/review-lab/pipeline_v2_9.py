#!/usr/bin/env python3
"""v2.9 ledger pipeline: structured candidate selection on top of v2.7."""
...
runner.PIPELINE_VERSION = "pipeline-v2.9"
runner.PROMPT_DIR = runner.SCRIPT_DIR / "prompts" / "pipeline-v2.9"
runner.STAGES = (
